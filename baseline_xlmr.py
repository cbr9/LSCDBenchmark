...
def xlmr_baseline():
        ...
        distance_targets_apd = open(path_results+'/apd/distance_targets_xlm_'+language+'.tsv','w',encoding='utf-8')
        distance_targets_cos = open(path_results+'/cos/distance_targets_xlm_'+language+'.tsv','w',encoding='utf-8')
        ...
        binary(path_results+'apd/distance_targets_xlm_'+language+'.tsv',path_results+'apd/scores_targets_xlm_'+language+'.tsv')
        binary(path_results+'cos/distance_targets_xlm_'+language+'.tsv',path_results+'cos/scores_targets_xlm_'+language+'.tsv')
